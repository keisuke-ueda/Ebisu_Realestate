...
<div class="container" style="padding: 100px 150px 0;">
  ...
  <form action="/questionnaire_mail" method="post" class="entry_form">
    <div class="main-content row px-5">
      ...
      <table class="gold_table mb-3 animation">
        <tbody>
          ...
          <tr>
            ...
            <td></td>
            <td>
              <input type="text" name="family_name_kana" required>
              <input type="text" name="first_name_kana" required>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="width: 22%;"><label for="name"><span class="badge badge-danger">必須</span>ご住所</label></td>
            <td>
      ...
      <div>
        ...
        <input type="checkbox" name="agree" required>個人情報の取り扱いについて同意の方はチェックを入れてください。
