...
?>
<div id="questionnaire" class="container pb-40px">
    <div class="">
    ...
    <div class="main-content center-block mx-auto">
        ...
        <form class="mailformpro" method="POST" action="{{ route('form.post') }}">
            <table class="gold_table table_questionnaire animation">
                ...
                <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="py-1">
                                        <select name="home_prefectures">
                                            ...
                                            <option value="{{ $prefecture }}" data-error_placement="#home_prefectures">
                                                {{$prefecture}}</option>
                                            @endforeach
                    ...
                    <tr>
                        ...
                        <td>
                            <div><input type="radio" name="housing_form" data-error_placement="#housing_form">分譲マンション
                            </div>
                            <div><input type="radio" name="housing_form" data-error_placement="#housing_form">一戸建持家
                            </div>
                            <div><input type="radio" name="housing_form" data-error_placement="#housing_form">賃貸マンション
                            </div>
                            <div><input type="radio" name="housing_form" data-error_placement="#housing_form">社宅・官舎
                            </div>
                            <div><input type="radio" name="housing_form" data-error_placement="#housing_form">その他<input
                                    class="ms-2" type="text"></div>
                                ...
                                <tr>
                                    ...
                                    <td class="py-1">
                                        <select name="work_prefectures">
                                            <option value="">選択</option>
                                            @foreach ($prefectures as $prefecture)
                                            <option value="{{ $prefecture }}" data-error_placement="#work_prefectures">
                                                {{$prefecture}}</option>
                                            @endforeach
            ...
            <div class="mt-2 animation">
                ...
                <div class="gold_line_bottom  pb-25px">
                ...
                <div class="gold_line_bottom pb-25px pt-30px">
                    <div class="questionnaire questionnaire2_1">
                        <p class="pb-2"><span class="question-num mr-20px">2</span>あなたがお住まいに求める条件をお聞かせください。(それぞれ3つ回答)
                        </p>
                        <p>【駅名】</p>
                        <ul>
            ...
            <p class="text-end animation mb-45px">アンケートにご協力いただき、誠にありがとうございました。</p>

            <button class="mh-parts btn btn-dark mx-auto mb-35px d-block"><span class="p-3">入力内容の確認</span></button>
        </form>
    </div>
    <div class="border border-dark animation">
    ...
    <img class="center-block mb-45px mx-auto d-block" style="width: 70%;" src="{{ asset('/images/お住まいのアンケート2.png') }}">
</div>
<div class="main-content center-block mx-auto">
    <div class="text-center caption1">
        <p class="m-none">下記のフォームに必要な項目を入力のうえ、「送信」ボタンを押してください。</p>
            ...
            <div class="gold_line_bottom mb-25px mt-30px">
                <div class="questionnaire questionnaire2_1">
                    ...
                    <ul>
                        <li><input type="checkbox" name="q2_1[]" value="1"
                                onclick="click_cb(3, 'questionnaire2_1');">恵比寿</li>
                        <li><input type="checkbox" name="q2_1[]" value="2" onclick="click_cb(3, 'questionnaire2_1');">目黒
                        </li>
                        <li><input type="checkbox" name="q2_1[]" value="3"
                                onclick="click_cb(3, 'questionnaire2_1');">白金台</li>
                        <li><input type="checkbox" name="q2_1[]" value="4"
                        ...
                        <li><input type="checkbox" name="q2_1[]" value="8"
                                onclick="click_cb(3, 'questionnaire2_1');">代官山</li>
                        <li><input type="checkbox" name="q2_1[]" value="9" onclick="click_cb(3, 'questionnaire2_1');">品川
                        </li>
                        <li><input type="checkbox" name="q2_1[]" value="10"
                                onclick="click_cb(3, 'questionnaire2_1');">三田</li>
                        <li><input type="checkbox" name="q2_1[]" value="11"
                ...
                <div class="questionnaire questionnaire2_3">
                    <p>【建物】</p>
                    <ul>
                        <li><input type="checkbox" name="q2_3[]" value="1" onclick="click_cb(3, 'questionnaire2_3');">価格
                        </li>
                        <li><input type="checkbox" name="q2_3[]" value="2" onclick="click_cb(3, 'questionnaire2_3');">広さ
                        </li>
                        <li><input type="checkbox" name="q2_3[]" value="3"
                                onclick="click_cb(3, 'questionnaire2_3');">間取り</li>
                        <li><input type="checkbox" name="q2_3[]" value="4" onclick="click_cb(3, 'questionnaire2_3');">眺望
                        </li>
                        <li><input type="checkbox" name="q2_3[]" value="5"
                                onclick="click_cb(3, 'questionnaire2_3');">駐車場有無
                        </li>
            ...
            <div class="gold_line_bottom mb-25px mt-30px">
                <div class="questionnaire questionnaire6_1">
                    ...
                    <ul>
                        ...
                        <li><input type="checkbox" name="q6[]" value="2">1LDK&emsp;&emsp;64㎡超&emsp;&emsp;14,000万円～</li>
                        <br>
                        <li><input type="checkbox" name="q6[]" value="3">2LDK&emsp;&emsp;88㎡超&emsp;&emsp;18,000万円～</li>
                        <br>
                        <li><input type="checkbox" name="q6[]" value="4">その他<input class="ms-2" type="text">
                        </li>
                    </ul>
