...
<div id="questionnaire" style="margin: 150px 200px 0px;" class="pb-40px">
    <div class="">
        <h1 class="p-title gold-title-2 text-center" style="margin-bottom: 50px;">お住いについてのアンケート</h1>
    ...
    <div class="main-content center-block mx-auto">
        ...
        <form class="mailformpro" method="POST" action="{{ route('form.post') }}">
            ...
            <div style="padding-left: 20px; padding-right: 20px;">
                <table class="gold-table-questionnaire animation"
                    style="width: 100%;">
                    <tbody>
                        <tr class="top">
                        ...
                        <tr>
                            <td colspan="2"><label for="name"><span class="badge badge-danger">必須</span>電話番号</label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p style="margin: 0;">※確認のためもう一度ご入力ください</p>
                        ...
                        <tr>
                            <td colspan="2"><label for="name"><span class="badge badge-danger">必須</span>勤務先名</label>
                            </td>
                            <td>
            ...
            <div class="animation">
                <p class="text-center py-3 text-white h5"
            ...
            <button class="mh-parts btn btn-dark mb-35px d-block mx-auto" style="width: 220px;"><span
                    class="p-3">入力内容の確認</span></button>

        </form>
    </div>
    <div class="border border-dark animation mb-40px">
