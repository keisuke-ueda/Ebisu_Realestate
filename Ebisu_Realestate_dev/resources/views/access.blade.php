...
<div class="main-content2">
    ...
    <div class="animation d-flex justify-content-between w-100" > 
        <img  class="d-block animation-1-zm" style="width: 45%" src="{{ asset('/images/access_shinjuku.png') }}">
        <img  class="d-block animation-1-zm" style="width: 45%" src="{{ asset('/images/access_shinagawa.png') }}">
    </div>
    <p class="text-end">image</p>

    <p class="ft2 gold-2 text-center">2駅7路線が利用可能。もっと自由な都心生活を。</p>
    <p class="ft2 text-center" style="">「ラ・アトレ恵比寿グランガーデン」は、<br>
        JR山手線・埼京線・湘南新宿ライン「恵比寿」駅徒歩11分の3路線、<br>
        東京メトロ日比谷線「恵比寿」駅徒歩13分の1路線、<br>
    ...
    <img class="w-100" src="{{ asset('/images/rosenzu-0411.svg') }}" style="">
    <p class="s9 m-0 ft2">※各駅への所要時間はJR線「恵比寿」駅発、東京メトロ日比谷線「恵比寿」駅発、また東京メトロ南北線・<br>
        &emsp;都営三田線「目黒」駅発の所要時間は日中平常時、平日の13時台及び(  )内は通勤時8時台の<br>
        &emsp;最短所要時間を表記しています。<br>
        ※所要時間には、乗り換え・待ち時間は含まれません。(JR線・東京メトロ線・都営地下鉄線時刻表調べ)<br>
    ...
    <p class="gold-2 animation ft2 text-center" style="">都心の様々な要所へ、<br>タクシーでの移動にも優れたロケーションです。</p>
    <div class="d-flex mx-auto justify-content-between align-items-end animation-0-zm" style="width:70%; margin-top:30px;">
        <img class="" src="{{ asset('/images/access_taxi.png') }}" style="width:60%;">
        <img class="" src="{{ asset('/images/taxi.svg') }}" style="width:35%;">
    </div>
    <div class="mx-auto" style="width:70%;">
        <p class="text-end" style="width:60%;">image</p>
    </div>
    

    <table class="taxi_table text-center w-100" style="margin-bottom:22px;">
        <tr class="border-bottom">
            <td></td>
            <td class="s12" style="">距離</td>
            <td class="s12" style="">日中料金</td>
            <td class="s12" style="">所要時間</td>
            <td class="s12" style="">深夜料金</td>
            <td class="s12" style="">所要時間</td>
        </tr>
        <tr class="border-bottom">
            <td class="text-start s11"><span class="s16">品 川 駅 </span>から<br>SHINAGAWA<br>(高輪口より乗車)</td>
            <td><span class="s16 border-start d-block" style="line-height:3;">3.9<span class="s11">km</span></span></td>
            <td><span class="s16">1,700</span>円</td>
            <td><span class="s16">14</span>分</td>
            <td><span class="s16">2,020</span>円</td>
            <td><span class="s16">14</span>分<span class="s16" style=""></span></td>
        </tr>
        <tr class="border-bottom">
            <td class="text-start s12"><span class="s16">六 本 木 駅 </span>から<br>ROPPONGI<br>(六本木交差点より乗車)</td>
            <td><span class="s16 border-start d-block" style="line-height:3;">3.5<span class="s11">km</span></span></td>
            <td><span class="s16">1,540</span>円</td>
            <td><span class="s16">12</span>分</td>
            <td><span class="s16">1,860</span>円</td>
            <td><span class="s16">12</span>分<span class="s16" style=""></span></td>
        </tr>
        <tr class="border-bottom">
            <td class="text-start s12"><span class="s16">銀 座 駅 </span>から<br>GINZA<br>(銀座4丁目交差点より乗車)</td>
            <td><span class="s16 border-start d-block" style="line-height:3;">6.9<span class="s11">km</span></span></td>
            <td><span class="s16">2,980</span>円</td>
            <td><span class="s16">24</span>分</td>
            <td><span class="s16">3,540</span>円</td>
            <td><span class="s16">23</span>分<span class="s16" style=""></span></td>
        </tr>
        <tr class="border-bottom">
            <td class="text-start s12"><span class="s16">東 京 駅 </span>から<br>TOKYO<br>(丸の内南口より乗車)</td>
            <td><span class="s16 border-start d-block" style="line-height:3;">7.9<span class="s11">km</span></span></td>
            <td><span class="s16">3,380</span>円</td>
            <td><span class="s16">26</span>分</td>
            <td><span class="s16">4,020</span>円</td>
            <td><span class="s16">26</span>分<span class="s16" style=""></span></td>
        </tr>
    </table>
    <p class="m-0 ft2 s9">※出典:Japan Taxi https://japantaxi<br>
        ※掲載の情報は2022年2月現在のJapan Taxiウェブサイトにて算出したもので実際の走行ルートは料金と異なる可能性があります。<br>
