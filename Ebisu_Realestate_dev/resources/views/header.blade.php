    ...
    <div class="header_links">
      ...
      <div class="header_link ms-3">
        <a href="/entry" class="mh-parts">
          <button type="button" class="s13 entry_btn text-white" style="height: 40px; width: 135px;">物件エントリー</button>
        </a>
      </div>

      <div class="header_link ms-3">
        <a href="/questionnaire">
          <button type="button" class="s13 questionnaire_btn text-white mh-parts" style="height: 40px; width: 135px;">お住まいのアンケート</button>
        </a>
      </div>
