...
<!-- 開発対象 -->
<img  class="d-block w-100" src="{{ asset('/images/Ebisu_1.png') }}">
<div class="container-fluid">
    <div class="main-content">
        ...
        <div class="row mt-5 mb-5">
            <p class="col-1"></p>
            <img  class="col-6" src="{{ asset('/images/Ebisu_2.png') }}">
            <div class="col-4 text-white d-flex flex-column justify-content-between align-items-center" style="background-color: #3c3939; padding: 60px 20px;">
        ...
        <div class="row mt-5 mb-5">
            ...
            <img  class="col-6" src="{{ asset('/images/Ebisu_3.png') }}">
            <p class="col-1"></p>
        </div>
    </div>
</div>
