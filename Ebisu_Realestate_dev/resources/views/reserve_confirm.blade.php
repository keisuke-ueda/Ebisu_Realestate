...
<div class="mx-auto ft2" id="reserve" style="padding:150px 0 50px; width: 800px;">
  ...
  <p class="" style="border-bottom:2px solid #000; padding-bottom:10px; margin:20px 0;">ご予約者様情報</p>
  ...
  <form class="mailformpro" style="padding-left:10px; padding-right:10px;" method="POST" action="{{ route('entry_form.post') }}">
    ...
    <table class="gold-table-reserve table-reserve animation ft2 s14">
      <tbody>
        ...
        <tr>
          <td colspan="2">
            <div class="mb-4"><label for="name"><span class="badge badge-danger s11">必須</span>メールアドレス</label></div>
            <div><label for="name"><span class="badge badge-danger s11">必須</span>メールアドレス(確認用)</label></div>
          </td>
          <td style="padding-top: 10px; padding-bottom: 10px;">
        ...
        <tr>
          ...
          <td></td>
          <td>
            <input type="textarea" name="remarks" data-type="" placeholder=""
              data-error_placement="#remarks" style="width:80%;height:100px;">
